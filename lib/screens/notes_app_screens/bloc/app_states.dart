...
class AppState {
  ...
  @override
  int get hashCode => Object.hash(isLoading, loginErrors, loginHandle, fetchedNotes);


}

extension UnorderedEquality on Object {
  bool isEqualTo(other) => const DeepCollectionEquality
      .unordered().equals(this, other,);
}